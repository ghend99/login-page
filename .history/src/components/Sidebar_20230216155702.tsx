export const Sidebar = () => {
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-links--register">
        <img
          className="sidebar-links-image--register"
          src={require("../images/create-account.png")}
        />
        <p className="sidebar-links-title--register">Register</p>
      </div>
    </div>
  );
};
