...
export const Create = () => {
  ...
  const schema = yup.object().shape({
    age: yup.number().positive().integer().min(16).required("Must be over 16."),
  });
  ...
  return (
    <div className="container-create">
      ...
      <main>
        ...
        <input className="date-picker" type={"date"} {...register("age")} />
        <p className="age-error">{errors.age?.message}</p>
        <div className="terms">
