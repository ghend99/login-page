...
6. Understanding the effectiveness of typescript in how it is used to avoid unnecessary errors improved my overall experience when developing this app. One thing I found in my other projects was that I would make mistakes such as inputting incorrect syntax values for my variables.
...
2. Expanding error handling, creating error messages that explain why an action failed.
