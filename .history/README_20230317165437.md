...
3. Allowing the user to create custom usernames and display this on the application.
4. Allow the user to keep themselves logged in when closing and re-opening the application.
